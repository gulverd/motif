                      ...
                      <div class="product-item-wrap has-post-thumbnail">
                        <div class="product-item-inner">
                          <div class="product-thumb">
                            ...
                            <div class="product-thumb-secondary"><img width="300" height="400" src="imgs/employees/'.$pic_url.'" alt="47" class="attachment-shop_catalog size-shop_catalog"/></div><a href="team_in.php?team_id='.$id.'" class="product-link">
                          ...
                          <div class="product-info">
                            <span class="price">
                              <span class="designera">Position: '.$position_en.'</span>
                              <a href="team_in.php?team_id='.$id.'">
                                <h3>'.$title_en.'</h3>
                              </a>
                          </div>
                        </div>
