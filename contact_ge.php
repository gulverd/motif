            ...
            <div class="row">
              <div class="col-md-12">
                <div class="contact-us-content">
                  <h2 id="funtika">საკონტაქტო ინფორმაცია</h2>
                  <div class="wpb_text_column">
                    <div class="wpb_wrapper">
                      <div class="row-icon-box row">
                        <div class="col-md-4" id="c_fonts">
                          <div class="col-md-12" id="funtika">
                        ...
                        <div class="col-md-8" id="c_fonts">
                          ...
                          <div class="col-md-7" id="c_fontsi">
                            <h4 id="funtika">დაგვიმეგობრდით სოციალურ ქსელებში:</h4>
                          </div>
