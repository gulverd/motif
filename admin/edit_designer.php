...
<?php 	
		...
		$query1 	= "SELECT * FROM designers WHERE id  = '$designer_id'";
	...
	<div class="col-md-12">
		<div class="container">
			...
			<div class="col-md-12 buti_wrapper_partners">
				<a href="designers.php" class="btn btn-default"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> უკან დაბრუნება</a>
			</div>
...
<?php
	...
	if(isset($_POST['submit'])){
		...
		$query = "UPDATE designers SET title_en = '$title_en' WHERE id = '$designer_id'";
