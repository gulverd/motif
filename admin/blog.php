					...
					if(mysqli_num_rows($run) >= 1){
						...
						while($row = mysqli_fetch_array($run)){
							...
							echo '<tr>
								...
								<td id="cent_td"><a href="edit_blog.php?blog_id='.$id.'" class="btn btn-primary">რედაქტირება</a></td>
								<td id="cent_td"><a href="del_blog.php?blog_id='.$id.'" class="btn btn-danger">წაშლა</a></td>
							</tr>';
						}
						echo '</table>';
					}else{
