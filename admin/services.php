	...
	<div class="col-md-12">
		<div class="container">
			<div class="col-md-12 dashboard_title_wrp">
				<h2>სერვისები <a href="create_service.php">სერვისის დამატება</a></h2>
			</div>
					...
					if(mysqli_num_rows($run) >= 1){
						...
						while($row = mysqli_fetch_array($run)){
							...
							echo '<tr>
								...
								<td id="cent_td"><a href="edit_service.php?service_id='.$id.'" class="btn btn-primary">რედაქტირება</a></td>
								<td id="cent_td"><a href="del_service.php?service_id='.$id.'" class="btn btn-danger">წაშლა</a></td>
							</tr>';
						}
						echo '</table>';
					}else{
