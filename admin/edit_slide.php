...
<?php 	
		...
		$query1 	= "SELECT * FROM slider WHERE id  = '$slide_id'";
	...
	<div class="col-md-12">
		<div class="container">
			...
			<div class="col-md-12 buti_wrapper_partners">
				<a href="slider.php" class="btn btn-default"><i class="fa fa-long-arrow-left" aria-hidden="true"></i> უკან დაბრუნება</a>
			</div>
			<div class="col-md-12 dashboard_buttons_main_wrp">
				<form method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<img src="..//imgs/slider/<?php echo $pic_url1;?>" id="ex_logo">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="submit" name="submit" value="რედაქტირება" class="btn btn-primary submit">
					</div>
				</form>
			</div>
		</div>
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    if($file_name != ''){
			    	$query = "UPDATE slider SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en', pic_url = '$fl_name' WHERE id = '$slide_id'";
					$run   = mysqli_query($conn,$query);
			    }else{
			    	$query = "UPDATE slider SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en' WHERE id = '$slide_id'";
					$run   = mysqli_query($conn,$query);
			    }
