		...
		<div class="container">
			...
			<div class="col-md-12 dashboard_buttons_main_wrp">
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>სლაიდერის შინაარსი (ENG)</label>
					...
					<div class="form-group">
						<label>სლაიდერის შინაარსი (GEO)</label>
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    $query = "INSERT INTO slider (title_en,title_ge,desc_en,desc_ge,pic_url) VALUES ('$title_en','$title_ge','$desc_en','$desc_ge','$fl_name')";
