		...
		<div class="container">
			...
			<div class="col-md-12 dashboard_buttons_main_wrp">
				<form action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>ბლოგის შინაარსი (ENG)</label>
					...
					<div class="form-group">
						<label>ბლოგის შინაარსი (GEO)</label>
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    $query = "INSERT INTO blogs (title_en,title_ge,desc_en,desc_ge,pic_url,datee) VALUES ('$title_en','$title_ge','$desc_en','$desc_ge','$fl_name','$blog_date')";
