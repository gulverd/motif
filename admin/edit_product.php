				...
				<form method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select class="form-control" name="cat_id">
							<?php
								$querCat1 = "SELECT * FROM subcategories WHERE parent_id='$cat_id1'";
								...
								$queryCat = "SELECT * FROM subcategories where parent_id != '$cat_id1'";
					...
					<div class="form-group">
						...
						<select class="form-control" name="brand_id">
							<?php
								$queryBrand1 = "SELECT * FROM brands WHERE id = '$brand_ida1'";
								$runBrand1   = mysqli_query($conn,$queryBrand1);

								while($rowBrand1 = mysqli_fetch_array($runBrand1)){
									$brand_id1   = $rowBrand1['id'];
									$brand_name1 = $rowBrand1['title_ge'];
									echo '<option value="'.$brand_id1.'">'.$brand_name1.'</option>'; 
								}

								$queryBrand = "SELECT * FROM brands WHERE id != '$brand_ida1'";
					...
					<div class="form-group">
						...
						<img src="..//imgs/products/<?php echo $pic_url1;?>" id="ex_logo">
					</div>
					<div class="form-group">
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    if($file_name != ''){
			    	$query = "UPDATE products SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en', cat_id = '$cata_id', brand_id = '$branda_id', pic_url = '$fl_name' WHERE id = '$product_id'";
					$run   = mysqli_query($conn,$query);
			    }else{
			    	$query = "UPDATE products SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en', cat_id = '$cata_id', brand_id = '$branda_id' WHERE id = '$product_id'";
					$run   = mysqli_query($conn,$query);
			    }
