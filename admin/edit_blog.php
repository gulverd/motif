			...
			<div class="col-md-12 dashboard_buttons_main_wrp">
				<form method="post" action="" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" name="name_en" class="form-control" placeholder="ქართული დასახელება" value="<?php echo $name_en1;?>">
					</div>
					<div class="form-group">
						<label>სახელი (GEO)</label>
						<input type="text" name="name_ge" class="form-control" placeholder="ინგლისური დასახელება" value="<?php echo $name_ge1;?>">
					</div>
					<div class="form-group">
						<label>არსებული სურათი</label></br>
						<img src="..//imgs/blog/<?php echo $pic_url1;?>" id="ex_logo">
					</div>
					<div class="form-group">
	...
	if(isset($_POST['submit'])){
		...
		if(isset($_FILES['image'])){
			...
			if(empty($errors)==true){
			    ...
			    if($file_name != ''){
			    	$query = "UPDATE blogs SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en', pic_url = '$fl_name' WHERE id = '$blog_id'";
					$run   = mysqli_query($conn,$query);
			    }else{
			    	$query = "UPDATE blogs SET title_en = '$name_en', title_ge = '$name_ge', desc_ge = '$desc_ge', desc_en = '$desc_en' WHERE id = '$blog_id'";
					$run   = mysqli_query($conn,$query);
			    }
