    <?php
        ...
        $querya = "SELECT  * FROM categories WHERE id = '$cat_id'";
    ...
    <div class="sn-site">
      ...
      <div id="example-wrapper">
        <div class="col-md-12" id="blogs_home_title">
          <h2 id="funtika"><?php echo $name;?></h2>
        </div>
      <section> 
          ...
          <div class="products-content product-tab">
            <div class="woocommerce product-listing columns-4 clearfix">
              <ul class="products-tabs nav nav-pills">
                <?php
                  $query1 = "SELECT * FROM subcategories WHERE parent_id = '$cat_id'";
                  $run1   = mysqli_query($conn,$query1);
                  while($row1 = mysqli_fetch_array($run1)){
                    $sub_id     = $row1['id'];
                    $sub_title  = $row1['title_ge'];  
                    echo '<li><a href="sub_category_in_ge.php?cat_id='.$cat_id.'&sub_id='.$sub_id.'" id="funtika">'.$sub_title.'</a></li>';
                  }
                ?>
              </ul>
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
                    $query2 = "SELECT a.id as id, a.pic_url as pic_url , a.title_ge as title_ge , b.title_en as designer, c.id as brand_id ,c.title_en as brand_name FROM products a JOIN designers b ON  a.designer_id = b.id  JOIN brands c ON a.brand_id = c.id WHERE a.cat_id = '$cat_id'";
                      ...
                      <div class="product-item-wrap has-post-thumbnail">
                        <div class="product-item-inner">
                          <div class="product-thumb">
                            ...
                            <div class="product-thumb-secondary"><img width="300" height="400" src="imgs/galery/'.$gal_image.'" alt="47" class="attachment-shop_catalog size-shop_catalog"/></div><a href="product_in_ge.php?cat_id='.$cat_id.'&product_id='.$id.'" class="product-link">
                          ...
                          <div class="product-info">
                            <span class="price">
                             <a href="product_in.php?cat_id='.$cat_id.'&product_id='.$id.'">
                                <h3 id="fontika">'.$title_en.'</h3>
                              </a>
                              <span class="designera" id="fontika">ბრენდი: <a href="brand_in_ge.php?brand_id='.$brand_id.'">'.$brand_name.'</a></span></br>
                              <span class="designera" id="fontika">დიზაინერი: '.substr($designer, 0,20).'...</span>     
                          </div>
                        </div>
                      </div>
