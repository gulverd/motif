            ...
            <div class="woocommerce product-listing columns-4 clearfix">
              ...
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
                    $query2 = "SELECT a.id as id, a.pic_url as pic_url , a.title_ge as title_ge , b.title_en as designer FROM products a JOIN designers b ON  a.designer_id = b.id WHERE a.sub_cat_id = '$sub'";
