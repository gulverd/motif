            ...
            <div class="row">
              ...
              <div class="col-md-10">
                <div class="about-us-content">
                  <h2 id="funtika">ჩვენ შესახებ</h2>
                  <div class="wpb_text_column wpb_content_element">
                    <div class="wpb_wrapper funtika" id="tut">
                      <?php
                        $query1 = "SELECT * FROM about";
                        $run1   = mysqli_query($conn,$query1);

                        while($row1 = mysqli_fetch_array($run1)){
                          $about_en = $row1['about_ge'];
                          echo $about_en;
                        }
                  ...
                  <div class="about-bottom">
                    ...
                    <div class="about-bottom-right col-md-6">
                     <div class="icon-box icon-box-style2">
                          ...
                          <div class="icon-box-right"><span id="funtika"><?php echo $address;?></span></div>
                        </div>
                        <div class="icon-box icon-box-style2">
