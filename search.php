              ...
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
					...
					$query2  = "SELECT a.id as id, a.pic_url as pic_url , a.title_en as title_en , b.title_en as designer, a.cat_id as cat_id FROM products a JOIN designers b ON  a.designer_id = b.id WHERE a.title_en like '$likevar'";
