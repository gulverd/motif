  ...
  <body class="product-page single-product variable-product">
    ...
    <div class="sn-site">
      <?php 
          ...
          $query2 = "SELECT a.id as id, a.title_ge as title_ge, a.desc_ge as desc_ge, a.pic_url as pic_url, b.title_en as designer, b.id as designer_id, c.title_ge as category_name, c.id as category_id, d.id as brand_id , d.title_ge as brand_name, e.id as sub_id , e.title_ge as subtitle 
          FROM products a 
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="summary-product entry-summary">
                    <h1 class="product_title" id="funtika"><?php echo $title_en;?></h1>
                    <div class="woocommerce-product-rating"></div>
                    <div class="product-single-short-description" id="funtika">
                      <?php echo $desc_en;?>
                    </div>
                    <div class="product_meta"><span class="sku_wrapper">
                        <label id="funtika">დიზაინერი:</label><span class="product-stock-status in-stock"><a href="designer_in_ge.php?designer_id=<?php echo $designer_id;?>"><?php echo $designer;?></a></span></span><span class="posted_in">
                        <label id="funtika">მწარმოებელი:</label><span class="sku"><a href="brand_in_ge.php?brand_id=<?php echo $brand_id;?>"><?php echo $brand_name;?></a></span></span><span class="product-stock-status-wrapper">
                        <label id="funtika">კატეგორია:</label><a href="category_in_ge.php?cat_id=<?php echo $category_id;?>"><?php echo $category_name;?></a> --/-- <a href="sub_category_in_ge.php?cat_id=<?php echo $category_id;?>&sub_id=<?php echo $sub_id;?>"><?php echo $subtitle;?></a></span>
                    </div>
