            ...
            <div class="woocommerce product-listing columns-4 clearfix">
              <ul class="products-tabs nav nav-pills">
                <?php
                  ...
                  while($row1 = mysqli_fetch_array($run1)){
                    ...
                    echo '<li><a href="sub_category_in_ge.php?cat_id='.$cat_id.'&sub_id='.$sub_id.'">'.$sub_title.'</a></li>';
                  }
                ?>
              </ul>
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
                    $query2 = "SELECT a.id as id, a.pic_url as pic_url , a.title_ge as title_ge , b.title_en as designer FROM products a JOIN designers b ON  a.designer_id = b.id WHERE a.cat_id = '$cat_id'";
                      ...
                      <div class="product-item-wrap has-post-thumbnail">
                        <div class="product-item-inner">
                          ...
                          <div class="product-info">
                            <span class="price">
                              <span class="designera" id="funtika">დიზაინერი: '.$designer.'</span>
                              <a href="product_in_ge.php?cat_id='.$cat_id.'&product_id='.$id.'" id="funtika">
