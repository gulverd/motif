                        ...
                        echo '
                              ...
                              <div class="entry-wrap">
                                <div class="entry-thumbnail-wrap">
                                  <div class="entry-thumbnail"><a href="blog_in.php?blog_id='.$id.'" class="entry-thumbnail_overlay"><img src="imgs/blog/'.$pic_url.'" alt="'.$title_en.'" width="400" height="267" class="img-responsive"/></a><a href="#" class="prettyPhoto"><i class="fa fa-arrows-alt"></i></a></div>
                                  <div class="date-overlay"><span class="day">04</span><span class="month">Apr</span></div>
                                </div>
                                <div class="entry-content-wrap">
                                  <div class="entry-detail">
                                    <h3 class="entry-title p-font"><a href="blog_in.php?blog_id='.$id.'">'.$title_en.'</a></h3>
                                    <div class="entry-post-meta-wrap">
                                      <ul class="entry-meta">
                                        <li class="entry-meta-date"><i class="fa fa-clock-o p-color"></i><a href="blog_in.php?blog_id='.$id.'"> '.$datee.'</a></li>
                                      </ul>
                                    </div>
                                    <a href="blog_in.php?blog_id='.$id.'" class="btn-readmore"><span class="span-text">View Blog</span></a>
                                  </div>
                                </div>
                              </div>
                            </div>';
                ...
                <div class="sidebar-blog">
                  <aside class="recent-post post-sidebar">
                    ...
                    while($row1 = mysqli_fetch_array($run1)){
                        ...
                        $desc_en  = $row1['desc_en'];
                        echo '
                          <li><a href="blog_in.php?blog_id='.$id.'"> <img src="imgs/blog/'.$pic_url.'" alt="sideber" width="70" height="70"/></a>
                          <div class="posts-thumbnail-content">
                            <h4><a href="blog_in.php?blog_id='.$id.'">'.$title_en.'</a></h4>
                          </div>
                        </li>
