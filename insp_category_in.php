            ...
            <div class="woocommerce product-listing columns-4 clearfix">
              ...
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
                    $query2 = "SELECT a.id as id, a.pic_url as pic_url , a.title_en as title_en , b.title_en as designer FROM products a JOIN designers b ON  a.designer_id = b.id WHERE a.cat_id = '$cat_id'";
                      ...
                      <div class="product-item-wrap has-post-thumbnail">
                        <div class="product-item-inner">
                          ...
                          <div class="product-info">
                            <span class="price">
                              <span class="designera">Designer: '.$designer.'</span>
