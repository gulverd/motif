        <section>
            <div class="container">
                  <div class="col-md-12" id="blogs_home_title">
                    <h2>Explore products by Brands</h2>
                    <h3>Our Brands</h3>
                  </div>
                  <div class="banner-home-2">
                    ...
                    <?php
                        ...
                        $query = "SELECT id, title_en, pic_url FROM brands ORDER BY rand() LIMIT 6";
                          ...
                          echo '
                            <div class="col-md-4" id="boxas">
                              <div class="banner-shortcode-wrap style-1">
                                  <a href="brand_in.php?brand_id='.$id.'">
                    ...
                    ?>
                      <div class="col-md-12" id="buti_wrp">
                        <a href="all_brands.php" class="btn btn-default" id="buti">Explore More Brands</a>
                      </div>
                    </div>
                  </div>
            </div>
