      <div class="section-no-margin">
          <footer class="footer footer-style-1" id="footer_wrp">
            <div class="footer-top">
              <div class="container"><a href="home_ge.php" title="Motif.ge"><img src="images/logo/logo.png" alt="logo" class="logo-img"/></a>
                <ul class="social-footer">
                 <?php

                  $query5  = "SELECT phone1,email1,address_ge,facebook, instagram, pinterest, youtube, linkedin FROM contact";
                  ...
                  <div class="row">
                    <div class="col-md-4">
                      <div class="icon-box icon-box-style2">
                        ...
                        <div class="icon-box-right"><span id="funtika"><?php echo $address_en;?></span></div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="icon-box icon-box-style2">
                        <div class="icon-box-left"><i class="fa fa-phone"></i></div>
                        <div class="icon-box-right"><span id="funtika">ტელეფონი : <?php echo $phone1;?></span></div>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="icon-box icon-box-style2">
                        <div class="icon-box-left"><i class="fa fa-envelope-o"></i></div>
                        <div class="icon-box-right"><span id="funtika">ელ-ფოსტა : <?php echo $email1;?></span></div>
                      </div>
                    </div>
                  </div>
                </div>
