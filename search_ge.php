    ...
    <div class="sn-site">
      ...
      <div id="example-wrapper">
        <div class="col-md-12" id="blogs_home_title">
          <h2 id="funtika">ძიების რეზულტატი სიტყვისთვის : <?php echo $search;?></h2>
        </div>
      <section> 
              ...
              <div class="desc-review-content tab-content clearfix">
                <div id="1a" class="tab-pane active">
                  <?php 
					...
					$query2  = "SELECT a.id as id, a.pic_url as pic_url , a.title_ge as title_ge , b.title_en as designer, a.cat_id as cat_id FROM products a JOIN designers b ON  a.designer_id = b.id WHERE a.title_ge like '$likevar'";
