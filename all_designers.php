        ...
        <section>
            <div class="container">
                  <div class="col-md-12" id="blogs_home_title">
                    <h2>Explore products by Designers</h2>
                    <h3>All Designers</h3>
                  </div>
                        ...
                        <table class="table table-bordered">
                          ...
                          <?php
                            ...
                            foreach ($array as $value) {
                              echo '<td id="cent_td"> <a href="all_designers.php?symbol='.$value.'" id="desing_a">'.$value.'</a></td>';
                            }
                      ...
                      <?php
                          ...
                          if($symbol == ''){
                            ...
                            while($row2 = mysqli_fetch_array($run2)){
                              ...
                              echo '<div class="col-md-2"><a href="designer_in.php?designer_id='.$id.'" id="desing_a">'.$title_en.'</a></div>';
                            }
