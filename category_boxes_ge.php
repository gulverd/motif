        <section>
            <div class="container">
                  <div class="col-md-12" id="blogs_home_title">
                    <h2>იხილეთ პროდუქცია კატეგორიების მიხედვით</h2>
                    <h3>კატეგორიები</h3>
                  </div>
                  <div class="banner-home-2">
                    ...
                    <?php
                        ...
                        $query = "SELECT id, title_ge, pic_url FROM categories ORDER BY rand() LIMIT 6";
                          ...
                          echo '
                            <div class="col-md-4" id="boxas">
                              <div class="banner-shortcode-wrap style-1">
                                  <a href="category_in_ge.php?cat_id='.$id.'" id="funtika">
                    ...
                    ?>
                      ...
                      <div class="col-md-12" id="buti_wrp">
                          <a href="all_categories_ge.php" class="btn btn-default funtika" id="buti">იხილეთ ყველა კატეგორია</a>
                      </div>
                    </div>
                  </div>
            </div>
